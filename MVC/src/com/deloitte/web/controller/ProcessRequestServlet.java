...
public class ProcessRequestServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (status) {
			...
			request.getRequestDispatcher("/homeblahblah.jsp").forward(request, response);
		} else {
			request.getRequestDispatcher("/loginblahblah.jsp?flag=true").forward(request, response);
